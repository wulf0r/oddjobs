...
## Entscheidung
Wir verwenden ein Monorepo mit klar getrennten Build-Welten. Gradle besitzt Backend, Shared-KMP, Flyway, jOOQ-Codegen und das Staging des Kotlin/JS-npm-Artefakts. pnpm besitzt das Frontend und konsumiert das lokal gestagte Paket `@example/shared` per Workspace.
